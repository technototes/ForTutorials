...
This is a copy of the FtcRobotController as of v7.1. The TechnoTotes are using it for teaching.

The general syllabus for teaching is in [the doc directory](doc/Syllabus.md).

The Android Studio getting started doc is [in the same place](doc/AndroidStudiomd).

# Below here: Old README
...
pasted into your /teachcode folder to be used as-is, or modified to suit your team's needs.
...
the [/TeachCode/src/main/java/org/firstinspires/ftc/teachcode](TeachCode/src/main/java/org/firstinspires/ftc/teachcode)
...
* Adds support for calling custom Java classes from Blocks OpModes (
  fixes [SkyStone issue #161](https://github.com/FIRST-Tech-Challenge/SkyStone/issues/161)).
    * Classes must be in the org.firstinspires.ftc.teachcode package.
...
* Initial support for UVC compatible cameras
    ...
    - Calibration settings for a few cameras are included (see
      TeachCode/src/main/res/xml/teamwebcamcalibrations.xml for details).
...
* Project structure has been reorganized so that there is now a TeachCode package that users can use
